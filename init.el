...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (swiper popup-kill-ring dmenu spaceline company dashboard rainbow-delimiters rainbow-delimeters sudo-edit hungry-delete switch-window rainbow-mode avy smex ido-vertical-mode org-bullets beacon exwm-config spacemacs-theme which-key use-package exwm))))
(custom-set-faces
